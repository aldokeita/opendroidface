...
object AliasResolver {
    ...
    private val aliases: Map<String, ActionHint> = mapOf(
        ...
        "kecerahan otomatis" to ActionHint("TOGGLE_AUTO_BRIGHTNESS", mapOf("state" to "toggle")),
        "matikan kecerahan otomatis" to ActionHint("TOGGLE_AUTO_BRIGHTNESS", mapOf("state" to "off")),
        "adaptive brightness" to ActionHint("TOGGLE_AUTO_BRIGHTNESS", mapOf("state" to "toggle")),
        "suara sentuh"       to ActionHint("TOGGLE_TOUCH_SOUNDS", mapOf("state" to "toggle")),
        "matikan suara sentuh" to ActionHint("TOGGLE_TOUCH_SOUNDS", mapOf("state" to "off")),
        "touch sounds"       to ActionHint("TOGGLE_TOUCH_SOUNDS", mapOf("state" to "toggle")),
        "getar dering"       to ActionHint("TOGGLE_VIBRATE_ON_RING", mapOf("state" to "toggle")),

        // Settings Android will not let a sideloaded app write. These land on
        // the exact switch rather than at the top of Settings.
        "mode pesawat"       to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "airplane")),
        "airplane mode"      to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "airplane")),
        "pengaturan lokasi"  to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "location")),
        "pengaturan baterai" to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "battery")),
        "battery saver"      to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "battery")),
        "pengaturan layar"   to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "display")),
        "pengaturan suara"   to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "sound")),
        "pengaturan wifi"    to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "wifi")),
        "pengaturan bluetooth" to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "bluetooth")),
        "pengaturan bahasa"  to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "language")),
        "pengaturan aksesibilitas" to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "accessibility")),
        "pengaturan penyimpanan" to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "storage")),
        "pengaturan aplikasi" to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "apps")),
        "developer options"  to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "developer")),
        "opsi pengembang"    to ActionHint("OPEN_SETTINGS_PAGE", mapOf("page" to "developer")),
